            ...
            item.mes.type
              ? mes.push(
                  <span key={i} className="keymes">
                    {' '}
                    {i18n('MockDoc.MockDoc.044434-0')}{item.mes.type}
                  </span>
                )
              : '';
            item.mes.required
            ...
            item.mes.desc
              ? mes.push(
                  <span key={i + 2} className="keymes">
                    {i18n('MockDoc.MockDoc.044434-2')}{item.mes.desc}
                  </span>
                )
              : '';
          }
...
MockDoc.defaultProps = {
  ...
  doc: [
    { type: 'strisng', key: 'ersrcode', required: true, desc: i18n('MockDoc.MockDoc.044434-3') },
    { type: 'number', key: 'data[]', required: true, desc: i18n('MockDoc.MockDoc.044434-4') },
    { type: 'object', key: 'data[].name', required: true, desc: i18n('MockDoc.MockDoc.044434-5') },
    { type: 'object', key: 'data[].name1[].name3', required: true, desc: i18n('MockDoc.MockDoc.044434-6') },
    { type: 'object', key: 'data1', required: true, desc: i18n('MockDoc.MockDoc.044434-6') },
    { type: 'object', key: 'data3.err', required: true, desc: i18n('MockDoc.MockDoc.044434-6') },
    { type: 'object', key: 'data3', required: true, desc: i18n('MockDoc.MockDoc.044434-6') },
    { type: 'object', key: 'data3.arr[]', required: true, desc: i18n('MockDoc.MockDoc.044434-6') }
  ]
};
