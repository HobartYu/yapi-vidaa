...
const METHODS_LIST = [
  { name: 'md5', type: false, params: [], desc: i18n('ModalPostman.MethodsList.057532-0') },
  { name: 'lower', type: false, params: [], desc: i18n('ModalPostman.MethodsList.057532-1') },
  { name: 'length', type: false, params: [], desc: i18n('ModalPostman.MethodsList.057532-2') },
  { name: 'substr', type: true, component: 'doubleInput', params: [], desc: i18n('ModalPostman.MethodsList.057532-3') },
  { name: 'sha', type: true, component: 'select', params: ['sha1'], desc: i18n('ModalPostman.MethodsList.057532-4') },
  { name: 'base64', type: false, params: [], desc: i18n('ModalPostman.MethodsList.057532-5') },
  { name: 'unbase64', type: false, params: [], desc: i18n('ModalPostman.MethodsList.057532-6') },
  { name: 'concat', type: true, component: 'input', params: [], desc: i18n('ModalPostman.MethodsList.057532-7') },
  { name: 'lconcat', type: true, component: 'input', params: [], desc: i18n('ModalPostman.MethodsList.057532-8') },
  { name: 'upper', type: false, desc: i18n('ModalPostman.MethodsList.057532-9') },
  { name: 'number', type: false, desc: i18n('ModalPostman.MethodsList.057532-10') }
];
...
class MethodsList extends Component {
  ...
  inputComponent = props => {
    ...
    return (
      <Input
        size="small"
        placeholder={i18n('ModalPostman.MethodsList.057532-11')}
        value={params[0]}
  ...
  selectComponent = props => {
    ...
    return (
      <Select
        value={params[0] || 'sha1'}
        placeholder={i18n('ModalPostman.MethodsList.057532-12')}
        style={{ width: 150 }}
        size="small"
  ...
  render() {
    ...
    return (
      <div className="modal-postman-form-method">
        <h3 className="methods-title title">{i18n('ModalPostman.MethodsList.057532-13')}</h3>
        ...
        {moreFlag && (
          <div className="show-more" onClick={this.showMore}>
            <Icon type="down" />
            <span style={{ paddingLeft: '4px' }}>{i18n('ModalPostman.MethodsList.057532-14')}</span>
          </div>
        )}
      </div>
    );
