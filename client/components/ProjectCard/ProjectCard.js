...
class ProjectCard extends Component {
  ...
  copy = async projectName => {
    ...
    message.success(i18n('ProjectCard.ProjectCard.841988-0'));
  ...
  showConfirm = () => {
    ...
    confirm({
      title: `${i18n('ProjectCard.ProjectCard.841988-1')}${that.props.projectData.name}${i18n('ProjectCard.ProjectCard.841988-2')}`,
      okText: i18n('ProjectCard.ProjectCard.841988-3'),
      cancelText: i18n('ProjectCard.ProjectCard.841988-4'),
      content: (
        <div style={{ marginTop: '10px', fontSize: '13px', lineHeight: '25px' }}>
          <Alert
            message={`${i18n('ProjectCard.ProjectCard.841988-5')}${that.props.projectData.name}${i18n('ProjectCard.ProjectCard.841988-11')}`}
            type="info"
          />
          <div style={{ marginTop: '16px' }}>
            <p>
              <b>{i18n('ProjectCard.ProjectCard.841988-6')}</b>
            </p>
            <Input id="project_name" placeholder={i18n('ProjectCard.ProjectCard.841988-7')} />
          </div>
        </div>
      ),
      async onOk() {
    ...
    return (
      <div className="card-container">
        ...
        >
          <Tooltip
            placement="rightTop"
            title={projectData.follow || inFollowPage ? i18n('ProjectCard.ProjectCard.841988-8') : i18n('ProjectCard.ProjectCard.841988-9')}
          >
            <Icon
        ...
        {isShow && (
          <div className="copy-btns" onClick={this.showConfirm}>
            <Tooltip placement="rightTop" title={i18n('ProjectCard.ProjectCard.841988-10')}>
