  ...
  render() {
    ...
    return (
      <Select
        mode="multiple"
        style={{ width: '100%' }}
        placeholder={i18n('UsernameAutoComplete.UsernameAutoComplete.576425-0')}
        filterOption={false}
        optionLabelProp="children"
        notFoundContent={fetching ? <span style={{ color: 'red' }}> {i18n('UsernameAutoComplete.UsernameAutoComplete.576425-1')}</span> : null}
