...
const tip = (
  <div className="title-container">
    <h3 className="title">{i18n('GroupList.GroupList.391348-0')}</h3>
    <p>
      {i18n('GroupList.GroupList.391348-1')} <b>{i18n('GroupList.GroupList.391348-2')}</b>{' '}
      {i18n('GroupList.GroupList.391348-3')}
    </p>
  </div>
);
    ...
    return (
      <div className="m-group">
        ...
        <div className="group-bar">
          <div className="curr-group">
            <div className="curr-group-name">
              ...
              <Tooltip title={i18n('GroupList.GroupList.391348-4')}>
                <a className="editSet">
            ...
            <div className="curr-group-desc">{i18n('GroupList.GroupList.391348-5')} {currGroup.group_desc}</div>
          </div>

          <div className="group-operate">
            <div className="search">
              <Search
                placeholder={i18n('GroupList.GroupList.391348-6')}
        ...
        {this.state.addGroupModalVisible ? (
          <Modal
            title={i18n('GroupList.GroupList.391348-4')}
          ...
          >
            <Row gutter={6} className="modal-input">
              <Col span="5">
                <div className="label">{i18n('GroupList.GroupList.391348-7')}</div>
              </Col>
              <Col span="15">
                <Input placeholder={i18n('GroupList.GroupList.391348-8')} onChange={this.inputNewGroupName} />
              </Col>
            </Row>
            <Row gutter={6} className="modal-input">
              <Col span="5">
                <div className="label">{i18n('GroupList.GroupList.391348-5')}</div>
              </Col>
              <Col span="15">
                <TextArea rows={3} placeholder={i18n('GroupList.GroupList.391348-10')} onChange={this.inputNewGroupDesc} />
              </Col>
            </Row>
            <Row gutter={6} className="modal-input">
              <Col span="5">
                <div className="label">{i18n('GroupList.GroupList.391348-11')}</div>
              </Col>
              <Col span="15">
