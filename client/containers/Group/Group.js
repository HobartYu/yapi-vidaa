        ...
        <Layout>
          ...
          >
            <Tabs type="card" className="m-tab tabs-large" style={{ height: '100%' }}>
              <TabPane tab={i18n('Group.Group.360148-0')} key="1">
                <ProjectList />
              </TabPane>
              {this.props.currGroup.type === 'public' ? (
                <TabPane tab={i18n('Group.Group.360148-1')} key="2">
                  <MemberList />
                </TabPane>
              ) : null}
              {['admin', 'owner', 'guest', 'dev'].indexOf(this.props.curUserRoleInGroup) > -1 ||
              this.props.curUserRole === 'admin' ? (
                <TabPane tab={i18n('Group.Group.360148-2')} key="3">
                  <GroupLog />
                </TabPane>
              ) : (
                ''
              ...
              this.props.currGroup.type !== 'private' ? (
                <TabPane tab={i18n('Group.Group.360148-3')} key="4">
                  <GroupSetting />
                </TabPane>
              ) : null}
            </Tabs>
