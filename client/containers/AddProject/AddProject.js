...
class ProjectList extends Component {
  ...
  async componentWillMount() {
    this.props.setBreadcrumb([{ name: i18n('AddProject.AddProject.111724-1') }]);
    ...
    return (
      <div className="g-row">
        <div className="g-row m-container">
          <Form>
            <FormItem {...formItemLayout} label={i18n('AddProject.AddProject.111724-2')}>
              {getFieldDecorator('name', {
                rules: nameLengthLimit(i18n('AddProject.AddProject.111724-3'))
              })(<Input />)}
            </FormItem>

            <FormItem {...formItemLayout} label={i18n('AddProject.AddProject.111724-4')}>
              {getFieldDecorator('group', {
                initialValue: this.state.currGroupId + '',
                rules: [
                  {
                    required: true,
                    message: i18n('AddProject.AddProject.111724-5')
                  }
                ]
              })(
                <Select>
            ...
            <FormItem
              ...
              label={
                <span>
                  {i18n('AddProject.AddProject.111724-6')}&nbsp;
                  <Tooltip title={i18n('AddProject.AddProject.111724-7')}>
            ...
            >
              {getFieldDecorator('basepath', {
                rules: [
                  {
                    required: false,
                    message: i18n('AddProject.AddProject.111724-8')
                  }
                ]
              })(<Input onBlur={this.handlePath} />)}
            </FormItem>

            <FormItem {...formItemLayout} label={i18n('AddProject.AddProject.111724-9')}>
              {getFieldDecorator('desc', {
                rules: [
                  {
                    required: false,
                    message: i18n('AddProject.AddProject.111724-10'),
                    max: 144
                  }
                ]
              })(<TextArea rows={4} />)}
            ...
            <FormItem {...formItemLayout} label={i18n('AddProject.AddProject.111724-11')}>
              {getFieldDecorator('project_type', {
                ...
                <RadioGroup>
                  <Radio value="private" className="radio">
                    <Icon type="lock" />{i18n('AddProject.AddProject.111724-12')}<br />
                    <span className="radio-desc">{i18n('AddProject.AddProject.111724-13')}</span>
                  </Radio>
                  <br />
          ...
          <Row>
            <Col sm={{ offset: 6 }} lg={{ offset: 3 }}>
              <Button className="m-btn" icon="plus" type="primary" onClick={this.handleOk}>
                {i18n('AddProject.AddProject.111724-14')}
              </Button>
            </Col>
          </Row>
        </div>
