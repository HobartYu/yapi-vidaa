...
class InterfaceColContent extends Component {
  ...
  handleChangeInterfaceCol = (desc, name) => {
    ...
    axios.post('/api/col/up_col', params).then(async res => {
      ...
      message.success(i18n('InterfaceCol.InterfaceColContent.573277-0'));
    });
  };
  ...
  handleTest = async interfaceData => {
    ...
    let result = {
      code: 400,
      msg: i18n('InterfaceCol.InterfaceColContent.573277-1'),
      validRes: []
    };
    ...
    try {
      ...
      if (validRes.length === 0) {
        ...
        result.validRes = [
          {
            message: i18n('InterfaceCol.InterfaceColContent.573277-2')
          }
        ];
  ...
  openReport = id => {
    if (!this.reports[id]) {
      return message.warn(i18n('InterfaceCol.InterfaceColContent.573277-3'));
    }
  ...
  handleAdvOk = async () => {
    ...
    if (res.data.errcode === 0) {
      message.success(i18n('InterfaceCol.InterfaceColContent.573277-4'));
    }
    this.setState({ advVisible: false });
  ...
  copyUrl = url => {
    copy(url);
    message.success(i18n('InterfaceCol.InterfaceColContent.573277-5'));
  };
  ...
  handleCommonSetting = ()=>{
    ...
    axios.post('/api/col/up_col', params).then(async res => {
      ...
      message.success(i18n('InterfaceCol.InterfaceColContent.573277-6'));
    });
  ...
  render() {
    ...
    const columns = [
      {
        property: 'casename',
        header: {
          label: i18n('InterfaceCol.InterfaceColContent.573277-7')
        },
        props: {
          style: {
            width: '250px'
              ...
              return (
                <Tooltip
                  title={
                    <span>
                      {' '}
                      {i18n('InterfaceCol.InterfaceColContent.573277-8')}{' '}
                      <a
                      ...
                      >
                        {' '}
                        {i18n('InterfaceCol.InterfaceColContent.573277-9')}{' '}
                      </a>{' '}
                      {i18n('InterfaceCol.InterfaceColContent.573277-10')}{' '}
                    </span>
                  }
                >
                  Key
      ...
      },
      {
        ...
        header: {
          label: i18n('InterfaceCol.InterfaceColContent.573277-11')
        },
        props: {
          style: {
            width: '100px'
            ...
            (value, { rowData }) => {
              ...
              switch (code) {
                ...
                case 400:
                  return (
                    <div>
                      <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-12')}>
                        <Icon
                          type="info-circle"
                          style={{
                            color: '#f04134'
                ...
                case 1:
                  return (
                    <div>
                      <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-13')}>
                        <Icon
      ...
      },
      {
        property: 'path',
        header: {
          label: i18n('InterfaceCol.InterfaceColContent.573277-14')
        },
        cell: {
          formatters: [
            (text, { rowData }) => {
              let record = rowData;
              return (
                <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-15')}>
      ...
      {
        header: {
          label: i18n('InterfaceCol.InterfaceColContent.573277-16')
        },
        props: {
          style: {
            width: '200px'
          ...
          formatters: [
            (text, { rowData }) => {
              let reportFun = () => {
                ...
                return <Button onClick={() => this.openReport(rowData.id)}>{i18n('InterfaceCol.InterfaceColContent.573277-16')}</Button>;
              };
    ...
    return (
      <div className="interface-col">
        <Modal
            title={i18n('InterfaceCol.InterfaceColContent.573277-17')}
          ...
          <div className="common-setting-modal">
            <Row className="setting-item">
              <Col className="col-item" span="4">
                <label>检查HttpCode:&nbsp;<Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-19')}>
              ...
              <Col className="col-item"  span="18">
                ...
                }} checked={this.state.commonSetting.checkHttpCodeIs200}  checkedChildren={i18n('InterfaceCol.InterfaceColContent.573277-20')} unCheckedChildren={i18n('InterfaceCol.InterfaceColContent.573277-21')} />
              </Col>
            </Row>

            <Row className="setting-item">
              <Col className="col-item"  span="4">
                <label>{i18n('InterfaceCol.InterfaceColContent.573277-22')}&nbsp;<Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-23')}>
                  <Icon type="question-circle-o" style={{ width: '10px' }} />
                </Tooltip></label>
              </Col>
              <Col  className="col-item" span="6">
                <Input value={this.state.commonSetting.checkResponseField.name} onChange={this.changeCommonFieldSetting('name')} placeholder={i18n('InterfaceCol.InterfaceColContent.573277-24')}  />
              </Col>
              <Col  className="col-item" span="6">
                <Input  onChange={this.changeCommonFieldSetting('value')}  value={this.state.commonSetting.checkResponseField.value}   placeholder={i18n('InterfaceCol.InterfaceColContent.573277-25')}  />
              </Col>
              <Col  className="col-item" span="6">
                <Switch  onChange={this.changeCommonFieldSetting('enable')}  checked={this.state.commonSetting.checkResponseField.enable}  checkedChildren={i18n('InterfaceCol.InterfaceColContent.573277-20')} unCheckedChildren={i18n('InterfaceCol.InterfaceColContent.573277-21')}  />
              </Col>
            </Row>

            <Row className="setting-item">
              <Col className="col-item" span="4">
                <label>{i18n('InterfaceCol.InterfaceColContent.573277-26')}&nbsp;<Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-27')}>
                  <Icon type="question-circle-o" style={{ width: '10px' }} />
                </Tooltip></label>
              </Col>
              <Col className="col-item"  span="18">
                ...
                }} checked={this.state.commonSetting.checkResponseSchema}  checkedChildren={i18n('InterfaceCol.InterfaceColContent.573277-20')} unCheckedChildren={i18n('InterfaceCol.InterfaceColContent.573277-21')} />
              </Col>
            </Row>

            <Row className="setting-item">
              <Col className="col-item  " span="4">
                <label>{i18n('InterfaceCol.InterfaceColContent.573277-28')}&nbsp;<Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-29')}>
                  <Icon type="question-circle-o" style={{ width: '10px' }} />
                </Tooltip></label>
              </Col>
              <Col className="col-item"  span="14">
                ...
                }} checked={this.state.commonSetting.checkScript.enable}  checkedChildren={i18n('InterfaceCol.InterfaceColContent.573277-20')} unCheckedChildren={i18n('InterfaceCol.InterfaceColContent.573277-21')}  /></div>
                <AceEditor
        ...
        <Row type="flex" justify="center" align="top">
          <Col span={5}>
            ...
            >
              {i18n('InterfaceCol.InterfaceColContent.573277-30')}&nbsp;<a
                target="_blank"
                rel="noopener noreferrer"
                href="https://hellosean1025.github.io/yapi/documents/case.html"
              >
                <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-31')}>
            ...
            {this.state.hasPlugin ? (
              ...
              >
                {this.props.curProjectRole !== 'guest' && (
                  <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-32')}>
                    <Button
                      style={{
                        marginRight: '8px'
                      }}
                    ...
                    >
                      {i18n('InterfaceCol.InterfaceColContent.573277-33')}
                    </Button>
                  </Tooltip>
                )}
                <Button onClick={this.openCommonSetting} style={{
                        marginRight: '8px'
                      }} >{i18n('InterfaceCol.InterfaceColContent.573277-17')}</Button>
                &nbsp;
                <Button type="primary" onClick={this.executeTests}>
                  {i18n('InterfaceCol.InterfaceColContent.573277-34')}
                </Button>
              </div>
            ) : (
              <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-35')}>
                <Button
                  disabled
                  type="primary"
                  style={{
                ...
                >
                  {i18n('InterfaceCol.InterfaceColContent.573277-36')}
                </Button>
              </Tooltip>
            )}
          </Col>
        ...
        <Modal
          title={i18n('InterfaceCol.InterfaceColContent.573277-16')}
          width="900px"
          style={{
            minHeight: '500px'
          }}
        ...
        <Modal
          title={i18n('InterfaceCol.InterfaceColContent.573277-36')}
          width="660px"
          style={{
            minHeight: '500px'
          }}
        ...
        >
          <h3>
            {i18n('InterfaceCol.InterfaceColContent.573277-37')}&nbsp;
            <Switch
        ...
        {this.state.autoVisible && (
          <Modal
            title={i18n('InterfaceCol.InterfaceColContent.573277-38')}
            width="780px"
            style={{
              minHeight: '500px'
            }}
          ...
          >
            <Row type="flex" justify="space-around" className="row" align="top">
              <Col span={3} className="label" style={{ paddingTop: '16px' }}>
                {i18n('InterfaceCol.InterfaceColContent.573277-39')}
                <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-40')}>
                  <Icon type="question-circle-o" />
                </Tooltip>
                &nbsp;：
              </Col>
            ...
            <Row type="flex" justify="space-around" className="row" align="middle">
              <Col span={3} className="label">
                {i18n('InterfaceCol.InterfaceColContent.573277-41')}
              </Col>
              <Col span={21}>
            ...
            <Row type="flex" justify="space-around" className="row" align="middle">
              <Col span={3} className="label">
                {i18n('InterfaceCol.InterfaceColContent.573277-42')}
                <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-43')}>
                  <Icon
              ...
              <Col span={21}>
                <Switch
                  ...
                  checkedChildren={i18n('InterfaceCol.InterfaceColContent.573277-20')}
                  unCheckedChildren={i18n('InterfaceCol.InterfaceColContent.573277-21')}
            ...
            <Row type="flex" justify="space-around" className="row" align="middle">
              <Col span={3} className="label">
                {i18n('InterfaceCol.InterfaceColContent.573277-44')}
                <Tooltip title={i18n('InterfaceCol.InterfaceColContent.573277-45')}>
                  <Icon
                    type="question-circle-o"
                    style={{
                      width: '10px'
            ...
            <Row type="flex" justify="space-around" className="row" align="middle">
              ...
              <Col span={3}>
                <Button className="copy-btn" onClick={() => this.copyUrl(localUrl + autoTestsUrl)}>
                  {i18n('InterfaceCol.InterfaceColContent.573277-46')}
                </Button>
              </Col>
            </Row>
            <div className="autoTestMsg">
              {i18n('InterfaceCol.InterfaceColContent.573277-47')}
            </div>
          </Modal>
        )}
      </div>
