...
class InterfaceEditForm extends Component {
        ...
        if (!err) {
          ...
          if (values.res_body_type === 'json') {
            if (this.state.res_body && validJson(this.state.res_body) === false) {
              return message.error(i18n('InterfaceList.InterfaceEditForm.264925-0'));
            }
            try {
          ...
          if (values.req_body_type === 'json') {
            if (this.state.req_body_other && validJson(this.state.req_body_other) === false) {
              return message.error(i18n('InterfaceList.InterfaceEditForm.264925-1'));
            }
            try {
          ...
          if (
            ...
            if (!values.req_body_other) {
              return message.error(i18n('InterfaceList.InterfaceEditForm.264925-2'));
            }
          }
          if (
            ...
            if (!values.res_body) {
              return message.error(i18n('InterfaceList.InterfaceEditForm.264925-3'));
            }
          }
  ...
  handleMockPreview = async () => {
    ...
    try {
      ...
      if (this.resBodyEditor.editor.curData.format === true) {
        ...
        str = i18n('InterfaceList.InterfaceEditForm.264925-4') + this.resBodyEditor.editor.curData.format;
      }
    } catch (err) {
      str = i18n('InterfaceList.InterfaceEditForm.264925-4') + err.message;
    }
  ...
  render() {
      ...
      return (
        <Row key={index} className="interface-edit-item-content">
          ...
          <Col span="4" draggable="false" className="interface-edit-item-content-col">
            ...
            })(<Input placeholder={i18n('InterfaceList.InterfaceEditForm.264925-5')} />)}
          </Col>
          <Col span="3" className="interface-edit-item-content-col">
            {getFieldDecorator('req_query[' + index + '].required', {
              ...
              <Select>
                <Option value="1">{i18n('InterfaceList.InterfaceEditForm.264925-6')}</Option>
                <Option value="0">{i18n('InterfaceList.InterfaceEditForm.264925-7')}</Option>
              </Select>
            )}
          </Col>
          <Col span="6" className="interface-edit-item-content-col">
            ...
            })(<TextArea autosize={true} placeholder={i18n('InterfaceList.InterfaceEditForm.264925-8')} />)}
          </Col>
          <Col span="9" className="interface-edit-item-content-col">
            {getFieldDecorator('req_query[' + index + '].desc', {
              initialValue: data.desc
            })(<TextArea autosize={true} placeholder={i18n('InterfaceList.InterfaceEditForm.264925-9')} />)}
          </Col>
      ...
      return (
        <Row key={index} className="interface-edit-item-content">
          ...
          <Col span="4" className="interface-edit-item-content-col">
            {getFieldDecorator('req_headers[' + index + '].name', {
              ...
              <AutoComplete
                ...
                placeholder={i18n('InterfaceList.InterfaceEditForm.264925-5')}
              />
            )}
          </Col>
          <Col span="5" className="interface-edit-item-content-col">
            ...
            })(<Input placeholder={i18n('InterfaceList.InterfaceEditForm.264925-10')} />)}
          </Col>
          <Col span="5" className="interface-edit-item-content-col">
        ...
        <Row key={index} className="interface-edit-item-content">
          <Col span="6" className="interface-edit-item-content-col">
            {getFieldDecorator('req_params[' + index + '].name', {
              initialValue: data.name
            })(<Input disabled placeholder={i18n('InterfaceList.InterfaceEditForm.264925-5')} />)}
          </Col>
          <Col span="7" className="interface-edit-item-content-col">
    ...
    return (
      <div>
        <Modal
          title={i18n('InterfaceList.InterfaceEditForm.264925-11')}
          width={680}
          visible={this.state.visible}
          onOk={this.handleBulkOk}
          onCancel={this.handleBulkCancel}
          okText={i18n('InterfaceList.InterfaceEditForm.264925-12')}
        >
          <div>
            <TextArea
              placeholder={i18n('InterfaceList.InterfaceEditForm.264925-13')}
        ...
        <Form onSubmit={this.handleSubmit}>
          <h2 className="interface-title" style={{ marginTop: 0 }}>
            {i18n('InterfaceList.InterfaceEditForm.264925-14')}
          </h2>
          <div className="panel-sub">
            <FormItem className="interface-edit-item" {...formItemLayout} label={i18n('InterfaceList.InterfaceEditForm.264925-15')}>
              {getFieldDecorator('title', {
                initialValue: this.state.title,
                rules: nameLengthLimit(i18n('InterfaceList.InterfaceEditForm.264925-16'))
              })(<Input id="title" placeholder={i18n('InterfaceList.InterfaceEditForm.264925-15')} />)}
            </FormItem>

            <FormItem className="interface-edit-item" {...formItemLayout} label={i18n('InterfaceList.InterfaceEditForm.264925-17')}>
              {getFieldDecorator('catid', {
                initialValue: this.state.catid + '',
                rules: [{ required: true, message: i18n('InterfaceList.InterfaceEditForm.264925-18') }]
              })(
                <Select placeholder={i18n('InterfaceList.InterfaceEditForm.264925-18')}>
            ...
            <FormItem
              ...
              label={
                <span>
                  {i18n('InterfaceList.InterfaceEditForm.264925-19')}&nbsp;
                  <Tooltip
                    title={
                      <div>
                        <p>
                          {i18n('InterfaceList.InterfaceEditForm.264925-20')}
                          {DEMOPATH}
                        </p>
                        <p>
                          {i18n('InterfaceList.InterfaceEditForm.264925-21')}
                        </p>
                      </div>
                    }
                  >
            ...
            >
              <InputGroup compact>
                ...
                <Tooltip
                  title={i18n('InterfaceList.InterfaceEditForm.264925-23')}
                  style={{
                ...
                {getFieldDecorator('path', {
                  ...
                  rules: [
                    {
                      required: true,
                      message: i18n('InterfaceList.InterfaceEditForm.264925-24')
                    }
                  ]
                })(
            ...
            <FormItem className="interface-edit-item" {...formItemLayout} label="Tag">
              {getFieldDecorator('tag', { initialValue: this.state.tag })(
                <Select placeholder={i18n('InterfaceList.InterfaceEditForm.264925-25')} mode="multiple">
                  ...
                  <Option value={i18n('InterfaceList.InterfaceEditForm.264925-26')} disabled style={{ cursor: 'pointer', color: '#2395f1' }}>
                    <Button type="primary" onClick={this.props.onTagClick}>
                      {i18n('InterfaceList.InterfaceEditForm.264925-27')}
                    </Button>
                  </Option>
                </Select>
              )}
            </FormItem>
            <FormItem className="interface-edit-item" {...formItemLayout} label={i18n('InterfaceList.InterfaceEditForm.264925-28')}>
              {getFieldDecorator('status', { initialValue: this.state.status })(
                <Select>
                  <Option value="done">{i18n('InterfaceList.InterfaceEditForm.264925-29')}</Option>
                  <Option value="undone">{i18n('InterfaceList.InterfaceEditForm.264925-30')}</Option>
                </Select>
              )}
            </FormItem>
            {custom_field.enable && (
              ...
              >
                ...
                })(<Input placeholder={i18n('InterfaceList.InterfaceEditForm.264925-31')} />)}
              </FormItem>
            )}
          </div>

          <h2 className="interface-title">{i18n('InterfaceList.InterfaceEditForm.264925-32')}</h2>
          ...
          <div className="panel-sub">
              ...
              <Row type="flex" justify="space-around">
                <Col span={12}>
                  <Button size="small" type="primary" onClick={() => this.addParams('req_query')}>
                    {i18n('InterfaceList.InterfaceEditForm.264925-33')}
                  </Button>
                </Col>
                <Col span={12}>
                  <div className="bulk-import" onClick={() => this.showBulk('req_query')}>
                    {i18n('InterfaceList.InterfaceEditForm.264925-34')}
                  </div>
                </Col>
              </Row>
            </FormItem>
            ...
            <FormItem className={'interface-edit-item ' + this.state.hideTabs.req.headers}>
              <Button size="small" type="primary" onClick={() => this.addParams('req_headers')}>
                {i18n('InterfaceList.InterfaceEditForm.264925-35')}
              </Button>
            </FormItem>
                  ...
                  <Col style={{ minHeight: '50px' }}>
                    <Row type="flex" justify="space-around">
                      <Col span="12" className="interface-edit-item">
                        ...
                        >
                          {i18n('InterfaceList.InterfaceEditForm.264925-36')}
                        </Button>
                      </Col>
                      <Col span="12">
            ...
            >
              <span>
                JSON-SCHEMA:&nbsp;
                {!projectMsg.is_json5 && (
                  <Tooltip title={i18n('InterfaceList.InterfaceEditForm.264925-37')}>
              ...
              {getFieldDecorator('req_body_is_json_schema', {
                ...
                <Switch
                  checkedChildren={i18n('InterfaceList.InterfaceEditForm.264925-39')}
                  unCheckedChildren={i18n('InterfaceList.InterfaceEditForm.264925-40')}
              ...
              <Col style={{ marginTop: '5px' }} className="interface-edit-json-info">
                {!this.props.form.getFieldValue('req_body_is_json_schema') ? (
                  <span>
                    {i18n('InterfaceList.InterfaceEditForm.264925-41')}{' '}
                    <Tooltip title={<pre>{Json5Example}</pre>}>
                      <Icon type="question-circle-o" style={{ color: '#086dbf' }} />
                    </Tooltip>
                    {i18n('InterfaceList.InterfaceEditForm.264925-42')}
                  </span>
                ) : (
                  <ReqBodySchema
                    onChange={text => {
          ...
          <h2 className="interface-title">
            {i18n('InterfaceList.InterfaceEditForm.264925-43')}&nbsp;
            {!projectMsg.is_json5 && (
              <Tooltip title={i18n('InterfaceList.InterfaceEditForm.264925-37')}>
            ...
            >
              <Col>
                <Tabs size="large" defaultActiveKey="tpl" onChange={this.handleJsonType}>
                  <TabPane tab={i18n('InterfaceList.InterfaceEditForm.264925-44')} key="tpl" />
                  <TabPane tab={i18n('InterfaceList.InterfaceEditForm.264925-45')} key="preview" />
                </Tabs>
                <div style={{ marginTop: '10px' }}>
                  {!this.props.form.getFieldValue('res_body_is_json_schema') ? (
                    <div style={{ padding: '10px 0', fontSize: '15px' }}>
                      <span>
                        {i18n('InterfaceList.InterfaceEditForm.264925-46')}{' '}
                        <Tooltip title={<pre>{Json5Example}</pre>}>
                          <Icon type="question-circle-o" style={{ color: '#086dbf' }} />
                        </Tooltip>{' '}
                          {i18n('InterfaceList.InterfaceEditForm.264925-47')}{' '}
                        <span
                          className="href"
                          onClick={() =>
                        ...
                        >
                          {i18n('InterfaceList.InterfaceEditForm.264925-48')}
                        </span>
                      </span>
                      {i18n('InterfaceList.InterfaceEditForm.264925-49')} <span style={{ fontWeight: '500' }}>F9</span>
                    </div>
                  ) : (
          ...
          <h2 className="interface-title">{i18n('InterfaceList.InterfaceEditForm.264925-50')}</h2>
          <div className="panel-sub">
          ...
          {/* ----------- email ------------- */}
          <h2 className="interface-title">{i18n('InterfaceList.InterfaceEditForm.264925-51')}</h2>
          <div className="panel-sub">
            <FormItem
              className={'interface-edit-item'}
              {...formItemLayout}
              label={
                <span>
                  {i18n('InterfaceList.InterfaceEditForm.264925-52')}&nbsp;
                  <Tooltip title={i18n('InterfaceList.InterfaceEditForm.264925-53')}>
                    <Icon type="question-circle-o" style={{ width: '10px' }} />
                  </Tooltip>
                </span>
              }
            >
              ...
              })(<Switch checkedChildren={i18n('InterfaceList.InterfaceEditForm.264925-39')} unCheckedChildren={i18n('InterfaceList.InterfaceEditForm.264925-40')} />)}
            </FormItem>
            <FormItem
              className={'interface-edit-item'}
              {...formItemLayout}
              label={
                <span>
                  {i18n('InterfaceList.InterfaceEditForm.264925-54')}&nbsp;
                  <Tooltip title={i18n('InterfaceList.InterfaceEditForm.264925-55')}>
                    <Icon type="question-circle-o" style={{ width: '10px' }} />
                  </Tooltip>
                </span>
              }
          ...
          >
            ...
            <Affix offsetBottom={0}>
              <Button
                ...
                htmlType="submit"
              >
                {i18n('InterfaceList.InterfaceEditForm.264925-56')}
              </Button>
            </Affix>
          </FormItem>
        </Form>
