...
class InterfaceMenu extends Component {
  ...
  handleAddInterface = (data, cb) => {
    ...
    axios.post('/api/interface/add', data).then(res => {
      ...
      message.success(i18n('InterfaceList.InterfaceMenu.894162-0'));
  ...
  handleAddInterfaceCat = data => {
    ...
    axios.post('/api/interface/add_cat', data).then(res => {
      ...
      message.success(i18n('InterfaceList.InterfaceMenu.894162-1'));
      this.getList();
  ...
  handleChangeInterfaceCat = data => {
    ...
    axios.post('/api/interface/up_cat', params).then(res => {
      ...
      message.success(i18n('InterfaceList.InterfaceMenu.894162-2'));
      this.getList();
      this.props.getProject(data.project_id);
      this.setState({
        change_cat_modal_visible: false
  ...
  showConfirm = data => {
    ...
    const ref = confirm({
      title: i18n('InterfaceList.InterfaceMenu.894162-3'),
      content: i18n('InterfaceList.InterfaceMenu.894162-4'),
      okText: i18n('InterfaceList.InterfaceMenu.894162-5'),
      cancelText: i18n('InterfaceList.InterfaceMenu.894162-6'),
      async onOk() {
  ...
  showDelCatConfirm = catid => {
    let that = this;
    const ref = confirm({
      title: i18n('InterfaceList.InterfaceMenu.894162-7'),
      content: i18n('InterfaceList.InterfaceMenu.894162-8'),
      okText: i18n('InterfaceList.InterfaceMenu.894162-5'),
      cancelText: i18n('InterfaceList.InterfaceMenu.894162-6'),
      async onOk() {
  ...
  render() {
    ...
    const searchBox = (
      <div className="interface-filter">
        <Input onChange={this.onFilter} value={this.state.filter} placeholder={i18n('InterfaceList.InterfaceMenu.894162-9')} />
        <Button
          type="primary"
          onClick={() => this.changeModal('add_cat_modal_visible', true)}
          className="btn-filter"
        >
          {i18n('InterfaceList.InterfaceMenu.894162-10')}
        </Button>
        {this.state.visible ? (
          <Modal
            title={i18n('InterfaceList.InterfaceMenu.894162-11')}
        ...
        {this.state.add_cat_modal_visible ? (
          <Modal
            title={i18n('InterfaceList.InterfaceMenu.894162-10')}
        ...
        {this.state.change_cat_modal_visible ? (
          <Modal
            title={i18n('InterfaceList.InterfaceMenu.894162-12')}
        ...
        <TreeNode
          title={
            ...
            >
              ...
              <div className="btns">
                <Tooltip title={i18n('InterfaceList.InterfaceMenu.894162-13')}>
                  <Icon
                    type="delete"
                ...
                <Tooltip title={i18n('InterfaceList.InterfaceMenu.894162-14')}>
                  <Icon
                    type="copy"
                    className="interface-delete-icon"
                    onClick={e => {
              ...
              <TreeNode
                ...
                title={
                  ...
                  >
                    ...
                    {i18n('InterfaceList.InterfaceMenu.894162-15')}
                  </Link>
                }
                key="root"
              />
                  ...
                  <TreeNode
                    title={
                      ...
                      >
                        ...
                        <div className="btns">
                          <Tooltip title={i18n('InterfaceList.InterfaceMenu.894162-16')}>
                            <Icon
                              type="delete"
                              className="interface-delete-icon"
                              onClick={e => {
                          ...
                          <Tooltip title={i18n('InterfaceList.InterfaceMenu.894162-12')}>
                            <Icon
                              type="edit"
                              className="interface-delete-icon"
                              style={{ display: this.state.delIcon == item._id ? 'block' : 'none' }}
                          ...
                          <Tooltip title={i18n('InterfaceList.InterfaceMenu.894162-11')}>
                            <Icon
                              type="plus"
                              className="interface-delete-icon"
                              style={{ display: this.state.delIcon == item._id ? 'block' : 'none' }}
