...
class InterfaceEdit extends Component {
  ...
  onSubmit = async params => {
    ...
    if (result.data.errcode === 0) {
      ...
      message.success(i18n('InterfaceList.Edit.527417-0'));
    } else {
  ...
  componentDidMount() {
    ...
    try {
      ...
      s.onerror = () => {
        ...
        console.warn(i18n('InterfaceList.Edit.527417-1'));
      };
    } catch (e) {
      this.setState({
        curdata: this.props.curdata,
      ...
      console.error(i18n('InterfaceList.Edit.527417-1'));
    }
  }
      ...
      <div className="interface-edit">
        ...
        {this.state.status === 2 ? (
          <div style={{ textAlign: 'center', fontSize: '14px', paddingTop: '10px' }}>
            ...
            <span>{i18n('InterfaceList.Edit.527417-3')}</span>
          </div>
        ) : null}
        {this.state.status === 0 && i18n('InterfaceList.Edit.527417-3')}

        <Modal
          title={i18n('InterfaceList.Edit.527417-4')}
          width={680}
          visible={this.state.visible}
          onOk={this.handleOk}
          onCancel={this.handleCancel}
          okText={i18n('InterfaceList.Edit.527417-5')}
        >
