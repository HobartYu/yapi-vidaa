...
export default class Project extends Component {
  ...
  render() {
    ...
    let routers = {
      interface: { name: i18n('Project.Project.450711-0'), path: '/project/:id/interface/:action', component: Interface },
      activity: { name: i18n('Project.Project.450711-1'), path: '/project/:id/activity', component: Activity },
      data: { name: i18n('Project.Project.450711-2'), path: '/project/:id/data', component: ProjectData },
      members: { name: i18n('Project.Project.450711-3'), path: '/project/:id/members', component: ProjectMember },
      setting: { name: i18n('Project.Project.450711-4'), path: '/project/:id/setting', component: Setting }
    };
    ...
    if (this.props.currGroup.type === 'private') {
      subnavData = subnavData.filter(item => {
        return item.name != i18n('Project.Project.450711-3');
      });
    }
