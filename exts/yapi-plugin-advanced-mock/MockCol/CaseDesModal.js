...
class CaseDesForm extends Component {
  ...
  endProcess = caseData => {
    ...
    if (paramsForm === 'form') {
      ...
      try {
        ...
        console.log(error);
        message.error(i18n('MockCol.CaseDesModal.641830-0'));
        return false;
      }
    }
  ...
  render() {
                ...
                <FormItem>
                  {getFieldDecorator(`paramsArr[${index}].name`, { initialValue: item.name })(
                    <AutoComplete
                      ...
                      placeholder={i18n('MockCol.CaseDesModal.641830-1')}
              ...
              <Col span={10}>
                <FormItem>
                  {getFieldDecorator(`paramsArr[${index}].value`, { initialValue: item.value })(
                    <Input placeholder={i18n('MockCol.CaseDesModal.641830-2')} />
                  )}
                </FormItem>
              </Col>
              <Col span={4}>
    ...
    return (
      <Modal
        title={isAdd ? i18n('MockCol.CaseDesModal.641830-3') : i18n('MockCol.CaseDesModal.641830-4')}
        visible={visible}
        maskClosable={false}
        onOk={this.handleOk}
        width={780}
      ...
      >
        <Form onSubmit={this.handleOk}>
          <h2 className="sub-title" style={{ marginTop: 0 }}>
            {i18n('MockCol.CaseDesModal.641830-5')}
          </h2>
          <FormItem {...formItemLayout} label={i18n('MockCol.CaseDesModal.641830-6')}>
                          ...
                          rules: [
                            {
                              ...
                              message: i18n('MockCol.CaseDesModal.641830-10'),
                              required: true
                            }
                          ]
                        }
                      : {}
                  )(<Input placeholder={i18n('MockCol.CaseDesModal.641830-11')} />)}
                </FormItem>
              </div>
            </Col>
          </FormItem>
          ...
          {valuesTpl(paramsArr, i18n('MockCol.CaseDesModal.641830-12'))}
          <FormItem
          ...
          >
            <Button
              ...
              style={{ width: '100%' }}
            >
              <Icon type="plus" /> {i18n('MockCol.CaseDesModal.641830-13')}
            </Button>
          </FormItem>
          <FormItem
            {...formItemLayout}
            wrapperCol={{ span: 17 }}
            label={i18n('MockCol.CaseDesModal.641830-12')}
            style={{ display: paramsForm === 'form' ? 'none' : '' }}
          >
            ...
            <FormItem>
              {getFieldDecorator(
                ...
                paramsForm === 'json'
                  ? {
                      rules: [
                        { validator: this.jsonValidator, message: i18n('MockCol.CaseDesModal.641830-14') }
                      ]
                    }
                  : {}
          ...
          <h2 className="sub-title">{i18n('MockCol.CaseDesModal.641830-15')}</h2>
          ...
          <FormItem {...formItemLayout} label={i18n('MockCol.CaseDesModal.641830-16')}>
          ...
          <FormItem wrapperCol={{ span: 6, offset: 5 }}>
            <Button
              ...
              style={{ width: '100%' }}
            >
              <Icon type="plus" /> {i18n('MockCol.CaseDesModal.641830-20')}
            </Button>
          </FormItem>
