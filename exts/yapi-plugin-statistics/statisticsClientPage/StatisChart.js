      ...
      <div>
        <Spin spinning={this.state.showLoading}>
          <div className="statis-chart-content">
            <h3 className="statis-title">{i18n('statisticsClientPage.StatisChart.869579-0')}{mockCount.toLocaleString()}</h3>
            <div className="statis-chart">
              ...
              >
                ...
                <Legend />
                <Line
                  name={i18n('statisticsClientPage.StatisChart.869579-1')}
                  type="monotone"
                  dataKey="count"
                  stroke="#8884d8"
                  activeDot={{ r: 8 }}
            ...
            <div className="statis-footer">{i18n('statisticsClientPage.StatisChart.869579-2')}</div>
          </div>
        </Spin>
      </div>
    );
