...
exports.timeago = function(timestamp) {
  ...
  if (year > 0) {
    return year + i18n('common.utils.639895-0');
  } else if (mouth > 0 && year <= 0) {
    return mouth + i18n('common.utils.639895-1');
  } else if (days > 0 && mouth <= 0) {
    return days + i18n('common.utils.639895-2');
  } else if (days <= 0 && hours > 0) {
    return hours + i18n('common.utils.639895-3');
  } else if (hours <= 0 && minutes > 0) {
    return minutes + i18n('common.utils.639895-4');
  } else if (minutes <= 0 && seconds > 0) {
    if (seconds < 30) {
      return i18n('common.utils.639895-5');
    } else {
      return seconds + i18n('common.utils.639895-6');
    }
  } else {
    return i18n('common.utils.639895-5');
  }
